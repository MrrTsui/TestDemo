...
import com.taotao.dao.IcontentCategoryDao;
...
public class ProductServiceImpl implements IproductService {
    ...
    @Override
    public List<ContentCategoryVO> getContentCatList(Map<String, Object> paraMap) {
        List<ContentCategoryVO> contentCatList = contentCategoryDao.selectByExample(paraMap);
