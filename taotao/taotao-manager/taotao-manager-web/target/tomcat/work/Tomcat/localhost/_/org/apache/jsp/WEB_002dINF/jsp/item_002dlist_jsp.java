 ...
 * Generated at: 2018-04-23 16:11:40 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\t// 加载商品描述\r\n");
      out.write("        \t\t\t$.getJSON('/product/getDesc/'+data.productId,function(_data){\r\n");
      out.write("        \t\t\t\tif(_data.status == 200){\r\n");
      out.write("        \t\t\t\t\t//UM.getEditor('itemeEditDescEditor').setContent(_data.data.itemDesc, false);\r\n");
      out.write("        \t\t\t\t\titemEditEditor.html(_data.data.desc);\r\n");
      out.write("        \t\t\t\t}\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\t\r\n");
      ...
      out.write("        \t    if (r){\r\n");
      out.write("        \t    \tvar params = {\"ids\":ids};\r\n");
      out.write("                \t$.post(\"/product/instock\",params, function(data){\r\n");
      out.write("            \t\t\tif(data.status == 200){\r\n");
      ...
      out.write("        \t    if (r){\r\n");
      out.write("        \t    \tvar params = {\"ids\":ids};\r\n");
      out.write("                \t$.post(\"/product/reshelf\",params, function(data){\r\n");
      out.write("            \t\t\tif(data.status == 200){\r\n");
